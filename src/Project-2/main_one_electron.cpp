...
{
    std::string filename_evec = "/Users/endriasa/Projects/FYS4150/src/Project2/DataFiles/Result_eigenvec_1el_"; // output filename definition
    ...
    std::string filename_eval = "/Users/endriasa/Projects/FYS4150/src/Project2/DataFiles/Result_eigenval_1el_"; // output filename definition
    ...
    fill_one_electron_array(A, n, rhomax);
    ...
    std::cout << "N = "<<n <<" nr. of rotaions = " << niter<<" ARMADILLO Time = "<< time_used_ARMA << " Jacobi Time = " << time_used << " rho max = " << rhomax << std::endl;
