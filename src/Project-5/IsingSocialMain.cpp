...
int main(int argc, char *argv[])
{
    ...
    if (argc >= 4){print_mc = atoi(argv[3]);std::cout << "pr" << print_all_agents;}   // If input bigger than 0, you will print out results at each step you input
    if (argc >= 5){print_all_agents = atoi(argv[4]); std::cout << "pr" << print_all_agents;}   // Input 1 to print out all spins, or input 0 to print out magnetization
    if (argc >= 6){consentration = atof(argv[5]); std::cout << "pr" << consentration;}  //  Input a concentration. 1 means all 1, and 0.9 means 90% 1's
