...
int main(int argc, char *argv[])
{
  ...
  else
  {
    ...
    "Prress 0 and Enter if you want the system to run with "+std::to_string(n_spins[0])+"x"+std::to_string(n_spins[0])+" "
    "spins, "+std::to_string(MC_samples)+" MC cycles , temprature =  "+std::to_string(T_0)+", on "+std::to_string(threads)+" threads";
...
// Metropolis Monte Carlo
void MMC_boundary_matrix(int n_spins, int MC_samples, double Temp, double expectation[5],
